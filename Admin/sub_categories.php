...
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="add_sub_categories.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-plus fa-sm text-white-50"></i> Add Sub Categories</a>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Sub Categories Details</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover " id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td class="w-25"><?php echo $row['sub_categories']; ?></td>
                                        <td>
                                        <?php
                                            if($row['status']==1){ 
                                        ...
                                        <td>
                                            <?php
                                                echo "<span style='width:100px;height:30px; padding-top: 8px;' class='badge badge-primary text-center'><a href='add_sub_categories.php?id=".$row['id']."' class='text-white'><i class='mr-1 las la-edit'></i>Edit</a></span>&nbsp;";
                                            ?>
                                        </td>
                                        <td>
                                            <?php
