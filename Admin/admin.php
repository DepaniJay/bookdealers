...
$sql = "select * from admin_users where adminlevel='Admin' order by name asc";
...
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="add_admin.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover " id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <?php
                                                echo "<span style='width:100px;height:30px; padding-top: 8px;' class='badge badge-primary text-center'><a href='add_admin.php?id=".$row['id']."' class='text-white'><i class='mr-1 las la-edit'></i>Edit</a></span>&nbsp;";
                                            ?>
                                        </td>
                                        <td>
                                            <?php
